...
now you can start and test with if everything work fine:

  mkdocs --version

If you like to look at your documentation

Go to main directory, where the mkdocs.yml file is stored
